...
const Carousel = () => {
  ...
  return (
    <div className='lg:h-screen h-[130vh] md:h-[110vh] w-full -mt-[88px]'>
        ...
        <div className='container mx-auto w-full'>
          <div className='flex h-full w-full pt-16'>
            <div>
              ...
              <Title addClass='lg:text-[90px] sm:text-[60px] text-6xl leading-snug mb-4'>
          ...
          <div className='w-full lg:mt-24 mt-8 rounded-lg'>
            <div className='grid grid-cols-12 gap-4 p-4  rounded-3xl'>
              <div className='lg:col-span-3 col-span-6 p-4 bg-primary rounded-3xl'>
                <div className='relative h-28 w-full transition-transform duration-300 ease-in-out transform hover:scale-110'>
                  <Image
                ...
                <Title addClass='text-3xl leading-snug mb-4 mt-2 text-center'>
                  Hamburger
                </Title>
                <p className='text-sm my-4 leading-snug opacity-75'>
